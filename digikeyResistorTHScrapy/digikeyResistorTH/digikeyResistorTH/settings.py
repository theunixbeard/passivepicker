...
BOT_NAME = 'digikeyResistorTH'

SPIDER_MODULES = ['digikeyResistorTH.spiders']
NEWSPIDER_MODULE = 'digikeyResistorTH.spiders'
...
MONGODB_COLLECTION = 'digikeyresistorsTHscrapy'
