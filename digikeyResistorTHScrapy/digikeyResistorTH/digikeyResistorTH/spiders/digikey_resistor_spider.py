...
from digikeyResistorTH.items import DigikeyResistorTHItem

from scrapy import log
from scrapy.http import Request
import re

class DigikeyResistorTHSpider(BaseSpider):
  base_url = "http://www.digikey.com/product-search/en/resistors/through-hole-resistors/66690?pageSize=500"
  name = "digikeyResistorTH"
  start_urls = [base_url]

  def __init__(self, category=None, *args, **kwargs):
    super(DigikeyResistorTHSpider, self).__init__(*args, **kwargs)
    self.last_page = -1
    self.current_page = 1
